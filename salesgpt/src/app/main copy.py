...
# 1. FastAPI 앱 인스턴스 생성
app = FastAPI(
    title="SalesGPT B2B Proposal Engine API",
...
class ProposalRequest(BaseModel):
    prompt: str = Field(
        ...
        example="삼성전자 2023년 재무 상태 분석하고 클라우드 전환 사업 제안서 개요 작성해줘."
    )
...
def generate_proposal(request: ProposalRequest):
    """
    사용자의 요청을 LangGraph State Machine으로 전달하여
    DART 데이터 및 RAG 지식을 융합한 답변을 반환합니다.
    """
